...
export default function index({ response }) {
  ...
  return (
    <div className=' border-white h-full   w-full flex gap-10  md:pt-[0px] px-6 lg:px-12  pb-12'>
      <div
        className={
          "absolute pointer-events-none opacity-70 blur top-[-10%] left-0 ease-animate  z-20  h-60 flex items-center justify-start  w-screen top-gradient"
        }
      ></div>
      ...
      <div className='w-3/4  z-10 h-full '>
        <div className=' flex flex-col  h-full gap-3 w-full'>
          <Chatbox loading={loading} chat={chat} character={currentCharacter} />
