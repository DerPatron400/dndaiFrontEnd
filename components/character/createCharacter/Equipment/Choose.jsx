...
export default function Choose({ equipments, handleSetEquipments }) {
  ...
  return (
    <div className='md:rounded-[16px]  w-full md:w-full lg:w-auto flex flex-col gap-6  h-full mb-auto md:p-5 md:pt-6  md:border border-white/10 md:bg-white/[8%]  overflow-auto hide-scrollbar'>
