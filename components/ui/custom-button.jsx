...
export default function CustomButton({
  ...
  return (
    <Button
      ...
      disabled={disabled}
      className={cn(
        "running-text-mono gap-2 h-[48px] px-6 bg-white/10 hover:bg-white/10 uppercase border border-white/10 hover:border-white/20 active:bg-white/20 active:border-white/40 disabled:opacity-30 rounded-[10px]  cursor-pointer z-[10] ease-animate disabled:pointer-events-none disabled:cursor-not-allowed hover:!duration-200 active:!duration-100",
