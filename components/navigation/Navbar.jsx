...
export default function Navbar({ variant }) {
  ...
  return (
    <div
      className={cn(
        " running-text-mono w-[95%] fixed rounded-2xl border border-white/10 top-[32px] left-[50%] translate-x-[-50%] flex bg-white/10 h-[64px]  justify-center p-[8px] ps-4 z-10",
