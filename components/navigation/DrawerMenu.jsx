...
export default function DrawerMenu({ isOpen, setIsOpen }) {
  ...
  return (
    ...
    >
      <div className='w-full px-5 mt-8 mx-auto rounded-lg text-white  flex justify-between items-center z-[100]'>
        <a
          href='#'
      ...
      <div className='mx-6 mt-10 gap-[34px] flex flex-col running-text-mono uppercase '>
